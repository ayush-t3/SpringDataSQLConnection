...
import com.example.demo.repository.RepoDao;
...
//	}
	...
	public List<Course> getAge(){
		return repoDao.getFullName();
	}
	...
	public List<Course> getfullNameCourses(){
		return courseService.getFullName();
	}
}
